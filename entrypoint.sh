...
curl -T /Users/andreykravchenko/Documents/git cayenne/bootique-tool/${1} -u ${INPUT_API_USER}:${INPUT_API_KEY} ${INPUT_API_URL}/content/${INPUT_REPOSITORY_USER}/${INPUT_REPOSITORY}/${INPUT_PACKAGE}/${INPUT_VERSION}/${INPUT_UPLOAD_PATH}/${FILENAME};publish=${INPUT_PUBLISH}
echo "    -> Done."